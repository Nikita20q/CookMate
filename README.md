...
CookMate - это умный помощник для подбора рецептов, который анализирует содержимое холодильника по фотографии и подбирает подходящие рецепты. Пользователь делает снимок продуктов, а система с помощью машинного обучения распознаёт ингредиенты и находит блюда, которые можно из них приготовить.
